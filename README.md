...
# Features
  ...
  may adjust the tracker to their personal needs. Once the user finished the initial setup and configuration of their preferences, a daily breakdown of those goals are formed into a concise card that
  ...
  where these markets are located may be created with different nutritional values, and not all food consumed derives from products from these companies. A person may cook a homemade meal, tracking the 
  nutritional data of a homemade meal is particularly difficult due to the serving sizes of recipes. Therefore, a custom food like homemade spaghetti and meatballs may differ from person to person based\
  ...
  ## Food Library
  The Food Library feature is a list of custom foods created by the acting user. Custom foods are not shared between users. There are no associated recipes, the custom foods primarily track a users nutritional data
...
5. Host the Expo app through Expo's server
